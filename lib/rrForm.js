...
import { actionSetField, actionSetForm, actionCloneAndSetForm, actionCopyAllFields, actionCopyFormFields, actionClearDirty } from './formActions';

export function rrform(Form) {
    var mapStateToProps = function mapStateToProps(state) {
        return {
            rrforms: _extends({}, state.rrforms)
        };
    };
